...
VS.ui.SearchFacet = Backbone.View.extend({
  ...
  searchAutocomplete : function(e) {	//gg5
    var autocomplete = this.box.data('ui-autocomplete');
    if (autocomplete) {
  ...
  enableEdit : function() {
    ...
    this.resize();
    this.searchAutocomplete();	//gg4 invoke value
    this.box.focus();
  },
  ...
  disableEdit : function() {		//if key presents then keep the values even after blur or removefocus
